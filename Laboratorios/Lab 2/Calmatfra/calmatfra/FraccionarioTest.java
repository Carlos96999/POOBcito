...
public class FraccionarioTest {
    ...
    {
        assertEquals(0, new Fraccionario(0,1).numerador());
    }
    
    @Test
    public void deberiaFallar()
    {
        assertEquals(0, new Fraccionario(3,6).numerador());
    }
    
    @Test
    public void deberiaErrar()
    {
        //Fraccionario f = new Fraccionario(1,0);
        assertEquals(1,1/0);
    }
...
// Pruebas de creacion de fraccionarios
	...
	public void noDeberiaHaberDenominadoresSimplificadosNegativos () {
		...
		//System.out.println("fr1 numerador "+fr1.numerador());
		//System.out.println("fr1 denominador "+fr1.denominador());
	...
	public void deberiaDarseCuentaSiDosFraccionariosSonIgualesConNegativos () {
	    Fraccionario fr1 = new Fraccionario(3,100);
	    assertEquals(true, fr1.equals(new Fraccionario(-3,-100)));
	    Fraccionario fr2 = new Fraccionario(-3,100);
	    assertEquals(true, fr2.equals(new Fraccionario(3,-100)));
	}
	...
	public void deberiaDarseCuentaSiDosFraccionariosCreadosDistintosSonIguales () {
	    ...
	    assertEquals (n1, new Fraccionario(54054,41580).numerador());
	    assertEquals (d1, new Fraccionario(54054,41580).denominador());
	    Fraccionario fr2 = new Fraccionario(13,10);
	    int n2 = fr2.numerador();
	    int d2 = fr2.denominador();
	    assertEquals (n2, new Fraccionario(54054,41580).numerador());
	    assertEquals (d2, new Fraccionario(54054,41580).denominador());
	}
